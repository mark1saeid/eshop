            ...
            child: Column(
              children: <Widget>[
                ...
                GestureDetector(
                  onTap: () => imageCapture(),
                  child: Text(
                    AppLocalizations.of(context).translate('edit photo')
                    ,
                    style: boldFont(MColors.primaryPurple, 14.0),
                  ),
                ),
            ...
            children: <Widget>[
              ...
              GestureDetector(
                ...
                child: Container(
                  ...
                  child: Text(
                    AppLocalizations.of(context).translate('capture with camera')
                    ,
              ...
              GestureDetector(
                ...
                child: Container(
                  ...
                  width: double.infinity,
                  child: Text(
                    AppLocalizations.of(context).translate('choose from photo gallery')
             ,
                    style: normalFont(MColors.textDark, 14.0),
                  ),
                ),
          ...
          child: Column(
            children: [
              ...
              primaryAppBar(
                ...
                Text(
                  AppLocalizations.of(context).translate('save Photo')
                ,
                  style: boldFont(MColors.primaryPurple, 16.0),
                ),
                MColors.primaryWhiteSmoke,
