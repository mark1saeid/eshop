...
import 'package:eShop/model/data/cart.dart';
...
import 'package:eShop/screens/tab_screens/checkout_screens/enterAddress.dart';
        ...
        child: primaryButtonPurple(
          ...
          () async {
            if (addressList.isEmpty || cardList.isEmpty) {
              showSimpleSnack(
                AppLocalizations.of(context).translate('please complete shipping and card details')
                ,
                Icons.error_outline,
                Colors.amber,
                _scaffoldKey,
              ...
              completeOrderFuture =
                  addCartToOrders(cartList, orderID, addressList,cardList.first.cardNumber=="Cash On Delivery"?"Cash On Delivery":"CreditCard",total);
          ...
          Row(
            children: <Widget>[
              ...
              Expanded(
                child: Container(
                  child: Text(
                    AppLocalizations.of(context).translate('shipping address')
                    ,
                ...
                child: RawMaterialButton(
                  onPressed: () async {
                    ...
                    if (navigationResult == true) {
                      ...
                      showSimpleSnack(
                        AppLocalizations.of(context).translate('address has been updated')
                        ,
      ...
      child: Column(
        ...
        children: <Widget>[
          ...
          Container(
            ...
            child: Text(
              AppLocalizations.of(context).translate('no shipping address added to this  account')
              ,
          ...
          primaryButtonWhiteSmoke(
            ...
            Text(
                AppLocalizations.of(context).translate('add a shipping address'),
                style: boldFont(MColors.primaryPurple, 16.0)),
            () async {
              UserDataAddressNotifier addressNotifier =
                  Provider.of<UserDataAddressNotifier>(context, listen: false);
        ...
        children: <Widget>[
          Row(
            children: <Widget>[
              ...
              Expanded(
                child: Container(
                  child: Text(
                    AppLocalizations.of(context).translate('bag summary')
                    ,
                    style: normalFont(MColors.textGrey, 14.0),
                  ),
                ),
          ...
          Container(
            ...
            child: Row(
              children: <Widget>[
                Text(
                    AppLocalizations.of(context).translate('total'), style: boldFont(MColors.primaryPurple, 16.0)),
                Spacer(),
                Text("\$" + total,
                    style: boldFont(MColors.primaryPurple, 16.0)),
              ],
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                Row(
                  children: <Widget>[
                    Container(
                      child:card.cardNumber == "Cash On Delivery"? Text(card.cardNumber,
                        style: normalFont(MColors.textGrey, 16.0),
                      ):Text(
                        "•••• •••• •••• " +
                            card.cardNumber
                    ...
                    Spacer(),
                    card.cardNumber == "Cash On Delivery"?Container() : Container(
                      child: SvgPicture.asset(
          ...
          child: AlertDialog(
            ...
            content: Container(
              ...
              child: Row(
                children: <Widget>[
                  Text(
                    AppLocalizations.of(context).translate('we are placing your order')
                    ,
                    style: normalFont(MColors.textGrey, 14.0),
                  ),
                  Spacer(),
