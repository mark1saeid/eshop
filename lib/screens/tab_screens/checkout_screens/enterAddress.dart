                ...
                children: <Widget>[
                  ...
                  Container(
                    child: searchTextField(
                      ...
                      _searchController,
                      null,
                      AppLocalizations.of(context).translate('search for your address')
                      ,
                      null,
                      null,
                      true,
                                ...
                                Row(
                                  children: <Widget>[
                                    ...
                                    Expanded(
                                      child: Container(
                                        child: Text(
                                          AppLocalizations.of(context).translate('use current location')
                                          ,
                                          style:
          ...
          Row(
            children: <Widget>[
              ...
              Expanded(
                child: Container(
                  child: Text(
                    AppLocalizations.of(context).translate('saved address')
                    ,
                  ...
                  children: <Widget>[
                    ...
                    Container(
                      ...
                      child: Text(
                        currentLocation == false
                            ?AppLocalizations.of(context).translate('please enter your legal name address name and number and apt or house number')
                            :AppLocalizations.of(context).translate('please enter your legal name and apt or house number'),
                    ...
                    Column(
                      ...
                      children: <Widget>[
                        Container(
                          child: Text(
                            AppLocalizations.of(context).translate('full legal name')
                            ,
                    ...
                    Column(
                      ...
                      children: <Widget>[
                        Container(
                          child: Text(
                            currentLocation == false
                                ?AppLocalizations.of(context).translate('apt or house number and street name and number')
                                :AppLocalizations.of(context).translate('apt or house number') ,
                            style: normalFont(MColors.textGrey, null),
                          ),
                        ),
                        SizedBox(height: 5.0),
                        ...
                        currentLocation == false
                            ? Container(
                                child: Text(
        AppLocalizations.of(context).translate('please enter information in order stated above')
                                  ,
                                  style:
