...
import 'package:eShop/screens/tab_screens/search_screens/search_tabs.dart';
      ...
      appBar: primaryAppBar(
        ...
        Container(
          ...
          child: searchTextField(
            ...
            _searchController,
            null,
            AppLocalizations.of(context).translate('search for products')
            ,
            null,
            null,
            true,
  ...
  Widget buildSearchBody(prods, cartProdID) {
    ...
    if (searchList.isEmpty) {
      return emptyScreen(
        ...
        AppLocalizations.of(context).translate('no search query')
        ,
        AppLocalizations.of(context).translate('type a product name in the search bar above')
        ,
      );
    } else {
      return SearchTabWidget(
