...
import 'package:eShop/screens/tab_screens/homeScreen_pages/bag.dart';
import 'package:eShop/utils/colors.dart';
import 'package:eShop/widgets/similarProducts_Wigdet.dart';
import 'package:eShop/widgets/allWidgets.dart';
import 'package:eShop/widgets/starRatings.dart';
    ...
    return Scaffold(
      ...
      bottomNavigationBar: Container(
        ...
        child: primaryButtonPurple(
          Text(AppLocalizations.of(context).translate('add to bag'), style: boldFont(MColors.primaryWhite, 16.0)),
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            Container(
              ...
              child: Text(
                AppLocalizations.of(context).translate('about this product')
                ,
            ...
            Container(
              child: Text(
                AppLocalizations.of(context).translate('similar products')
                ,
                style: boldFont(MColors.textDark, 16.0),
              ),
            ),
